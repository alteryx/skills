...
The Ask Alteryx team should review repository access at least quarterly and
when maintainers change roles. Remove access that is no longer needed.

## Lifecycle Management

The Ask Alteryx team decides whether this repository is active, maintenance
only, archived, transferred, or deprecated. Lifecycle changes should be
reflected in the README and any marketplace metadata before users are affected.

## Brand and Trust Controls

Maintainers should monitor for confusing forks, lookalike repositories,
typosquatted packages, fake maintainers, unofficial releases, and misuse of
Alteryx branding or official trust signals.
